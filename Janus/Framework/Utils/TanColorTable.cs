...
namespace Rsdn.Janus
{
	internal class TanColorTable : ProfessionalColorTable
	{
		...
		private bool UseBaseColorTable
		{
			get
			{
				var flag1 = !DisplayInformation.IsLunaTheme ||
		...
		#region Nested type: DisplayInformation
			...
			private static void SetScheme()
			{
				...
				if (VisualStyleRenderer.IsSupported)
				{
					...
					if (!VisualStyleInformation.IsEnabledByUser)
						return;
					var builder1 = new StringBuilder(0x200);
					GetCurrentThemeName(builder1, builder1.Capacity, null, 0, null, 0);
					var text1 = builder1.ToString();
					isLunaTheme = string.Equals("luna.msstyles", Path.GetFileName(text1),
		...
		#region Nested type: KnownColors
