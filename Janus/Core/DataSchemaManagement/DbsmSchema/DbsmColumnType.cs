namespace Rsdn.Janus
{
	public enum DbsmColumnType
	{
		...
		DoublePrecision,			//DOUBLE PRECISION specifies the data type approximate numeric, with implementation-defined precision
		...
		Timestamp,	// comprises values of the datetime fields YEAR (between 0001 and 9999), MONTH, DAY, HOUR, MINUTE and SECOND.
		Interval,
		//
		Unknown,
		// None ANSI Types
