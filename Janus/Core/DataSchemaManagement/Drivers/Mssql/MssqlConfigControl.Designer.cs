namespace Rsdn.Janus
{
	partial class MssqlConfigControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.lsbMsSqlBasesExist.SelectedIndexChanged += new System.EventHandler(this.lsbMsSqlBasesExist_SelectedIndexChanged);
			// 
			// label3
			// 
			...
			this.rbtMsSqlWinAuth.CheckedChanged += new System.EventHandler(this.rbtMsSqlWinAuth_CheckedChanged);
			// 
			// label1
			// 
