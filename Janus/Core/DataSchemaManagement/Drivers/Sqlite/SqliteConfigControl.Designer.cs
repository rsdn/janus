...
{
	partial class SqliteConfigControl
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this._selectDatabasePathOpenFileDialog = new System.Windows.Forms.OpenFileDialog();
			this.SuspendLayout();
			// 
			...
			// 
			// _selectDatabasePathOpenFileDialog
			// 
			this._selectDatabasePathOpenFileDialog.CheckFileExists = false;
			this._selectDatabasePathOpenFileDialog.Filter = "All files (*.*)|*.*";
			this._selectDatabasePathOpenFileDialog.RestoreDirectory = true;
			// 
			// SqliteConfigControl
			// 
		...
		private System.Windows.Forms.OpenFileDialog _selectDatabasePathOpenFileDialog;
	}
}
