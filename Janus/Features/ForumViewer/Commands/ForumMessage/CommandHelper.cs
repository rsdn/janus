...
namespace Rsdn.Janus
{
	public static class ForumMessageCommandHelper
	{
		...
		/// </summary>
		public static Action SubscribeMessageCommandStatusChanged(
			IServiceProvider serviceProvider, Action handler)
		{
			...
			if (activeMsgSvc != null)
			{
				...
				return () => activeMsgSvc.ActiveMessagesChanged -= statusUpdater;
			}
			return null;
		}
		...
		public static IMsg GetMessage(IServiceProvider serviceProvider, int? messageId)
		{
			return messageId != null
				? DatabaseManager.GetMessageWithForum(messageId.Value)
				: serviceProvider
